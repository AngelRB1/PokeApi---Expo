...
interface Props {
    ...
    esFavorito?: boolean;
    onToggleFavorito?: (pokemon: PokemonCardType) => void;
}

export default function PokemonCard({ pokemon, onPress, esFavorito = false, onToggleFavorito }: Props) {
        ...
        >
            ...
            {onToggleFavorito && (
                ...
                >
                    <Heart
                        size={18}
                        color={esFavorito ? "#ff4d6d" : "#999"}
                        fill={esFavorito ? "#ff4d6d" : "transparent"}
                    />
                </TouchableOpacity>
)}
